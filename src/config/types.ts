export interface Executor {
  ...
  detected: Detected;
  /** A sentence that explains why this executor must be used with caution, if applicable */
  warning?: string;
  /** A link that elaborates on why this executor must be used with caution, if applicable. */
  warningLink?: string;
